...
namespace UPM_IPS.JDCCCAJDOMDCMProyectoIPS
{
	...
	/// </remarks>
	public partial class JDCCCAJDOMDCMProyectoIPSToolboxHelper : JDCCCAJDOMDCMProyectoIPSToolboxHelperBase 
	{
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSToolboxHelper.
		/// </summary>
		public JDCCCAJDOMDCMProyectoIPSToolboxHelper(global::System.IServiceProvider serviceProvider)
	...
	public abstract class JDCCCAJDOMDCMProyectoIPSToolboxHelperBase
	{
		/// <summary>
		/// Toolbox item filter string used to identify JDCCCAJDOMDCMProyectoIPS toolbox items.  
		/// </summary>
		/// <remarks>
		...
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSToolboxHelperBase.
		/// </summary>
		protected JDCCCAJDOMDCMProyectoIPSToolboxHelperBase(global::System.IServiceProvider serviceProvider)
		{
		...
		public virtual DslDesign::ModelingToolboxItem GetToolboxItem(string itemId, DslModeling::Store store)
		{
			...
			global::System.Resources.ResourceManager resourceManager = global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.JDCCCAJDOMDCMProyectoIPSDomainModel.SingletonResourceManager;
			...
			switch(itemId)
			{
				...
				case "UPM_IPS.JDCCCAJDOMDCMProyectoIPS.MenuToolToolboxItem":
					...
					break;
				case "UPM_IPS.JDCCCAJDOMDCMProyectoIPS.BotonToolToolboxItem":
					// Add BotonTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.JDCCCAJDOMDCMProyectoIPS.BotonToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						...
						"UPM_IPS.JDCCCAJDOMDCMProyectoIPS.BotonToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("BotonToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
						...
						CreateElementToolPrototype(store, global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Boton.DomainClassId), // ElementGroupPrototype (data object) representing model element on the toolbox.
						new global::System.ComponentModel.ToolboxItemFilterAttribute[] { // Collection of ToolboxItemFilterAttribute objects that determine visibility of the toolbox item.
						new global::System.ComponentModel.ToolboxItemFilterAttribute(ToolboxFilterString, global::System.ComponentModel.ToolboxItemFilterType.Require) 
						});
					break;
				case "UPM_IPS.JDCCCAJDOMDCMProyectoIPS.ItemMenuToolToolboxItem":
					// Add ItemMenuTool shape tool.
					result = new DslDesign::ModelingToolboxItem(
						"UPM_IPS.JDCCCAJDOMDCMProyectoIPS.ItemMenuToolToolboxItem", // Unique identifier (non-localized) for the toolbox item.
						1, // Position relative to other items in the same toolbox tab.
						...
						"UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Item MenuToolboxTab", // Unique identifier (non-localized) for the toolbox item tab.
						resourceManager.GetString("Item MenuToolboxTab", resourceCulture), // Localized display name for the toolbox tab.
		...
		protected DslModeling::Store ToolboxStore
		{
			...
			{ 
				if (toolboxStore==null)
				{
					...
					toolboxStore.LoadDomainModels(typeof(global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.JDCCCAJDOMDCMProyectoIPSDomainModel));
