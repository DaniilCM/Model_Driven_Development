...
namespace UPM_IPS.JDCCCAJDOMDCMProyectoIPS
{
	...
	/// </summary>
	public static partial class navegaBuilder
	{
		...
		public static bool CanAcceptSource(DslModeling::ModelElement candidate)
		{
			...
			else if (candidate is global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Navegador)
			{ 
				return true;
			}
			else
		...
		{
			if (candidate == null) return false;
			else if (candidate is global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Ventana)
			{ 
				return true;
			}
			else
		...
		public static bool CanAcceptSourceAndTarget(DslModeling::ModelElement candidateSource, DslModeling::ModelElement candidateTarget)
		{
			...
			else // Check combinations
			{
				...
				{
					if (candidateTarget is global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Ventana)
					{
		...
		public static DslModeling::ElementLink Connect(DslModeling::ModelElement source, DslModeling::ModelElement target)
		{
			...
			if (CanAcceptSourceAndTarget(source, target))
			{
				...
				{
					if (target is global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Ventana)
					{
						...
						global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Ventana targetAccepted = (global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.Ventana)target;
						DslModeling::ElementLink result = new global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.navega(sourceAccepted, targetAccepted);
	...
	internal partial class NavegadorVentanaToolConnectAction : DslDiagrams::ConnectAction
	{
		...
		private partial class NavegadorVentanaToolConnectionTypeBase : DslDiagrams::ConnectionType
		{
			...
			/// </summary>
			/// <remarks>
			/// This implementation delegates calls to the ConnectionBuilder navegaBuilder.
			/// </remarks>
