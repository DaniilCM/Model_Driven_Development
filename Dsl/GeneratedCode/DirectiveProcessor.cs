...
namespace UPM_IPS.JDCCCAJDOMDCMProyectoIPS
{
	...
	/// <summary>
	/// Double-derived template directive processor that provides JDCCCAJDOMDCMProyectoIPS files
	/// The implementation is done in JDCCCAJDOMDCMProyectoIPSDirectiveProcessorBase. This class
	/// exist so users can customize behavior easily.
	/// </summary>
	public sealed partial class JDCCCAJDOMDCMProyectoIPSDirectiveProcessor : JDCCCAJDOMDCMProyectoIPSDirectiveProcessorBase
	{
		/// <summary>
		/// Constructor
		/// </summary>
		public JDCCCAJDOMDCMProyectoIPSDirectiveProcessor()
			: base()
		{
		}
	}
	...
	/// <summary>
	/// Base implementation for template directive processor that provides JDCCCAJDOMDCMProyectoIPS files
	/// </summary>
	public class JDCCCAJDOMDCMProyectoIPSDirectiveProcessorBase : VSTextTemplating::RequiresProvidesDirectiveProcessor
	{
		/// <summary>
		/// The friendly name of this processor.
		/// </summary>
		public const string JDCCCAJDOMDCMProyectoIPSDirectiveProcessorName = "JDCCCAJDOMDCMProyectoIPSDirectiveProcessor";
		...
		/// </summary>
		private const string providesModelParameter = "TapizVentanas";
		...
		/// </summary>
		private const string supportedDirectiveName = "JDCCCAJDOMDCMProyectoIPS";
		...
		/// Constructor
		/// </summary>
		public JDCCCAJDOMDCMProyectoIPSDirectiveProcessorBase()
			: base()
		{
		}
		...
		protected override string FriendlyName
		{
			get
			{
				return JDCCCAJDOMDCMProyectoIPSDirectiveProcessorName;
			}
		}
		...
		protected override void GenerateTransformCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				if (languageProvider != null)
				{
					...
					rootElement.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.TapizVentanas));
					...
					rootElementProperty.Type = new global::System.CodeDom.CodeTypeReference(typeof(global::UPM_IPS.JDCCCAJDOMDCMProyectoIPS.TapizVentanas));
					...
					if (!this.oneTimeCodeGenerated && global::System.IO.File.Exists(this.Host.TemplateFile))
					{
						...
						resolver.Name = "Convert" + "TapizVentanas" + "RelativePathToTemplateRelativePath";
		...
		protected override void GeneratePreInitializationCode(string directiveName, global::System.Text.StringBuilder codeBuffer, global::System.CodeDom.Compiler.CodeDomProvider languageProvider, global::System.Collections.Generic.IDictionary<string, string> requiresArguments, global::System.Collections.Generic.IDictionary<string, string> providesArguments)
		{
			if ((global::System.StringComparer.OrdinalIgnoreCase.Compare(directiveName, supportedDirectiveName) == 0))
			{
				...
				{
					string[] domainModels = {
						"UPM_IPS.JDCCCAJDOMDCMProyectoIPS.JDCCCAJDOMDCMProyectoIPSDomainModel",
					};
				...
				if (languageProvider != null)
				{
					...
					if(LoadDiagramData)
					{
						...
						invokeEnableDiagramRules = new global::System.CodeDom.CodeMethodInvokeExpression(
							new global::System.CodeDom.CodeMethodReferenceExpression(new global::System.CodeDom.CodeTypeReferenceExpression("JDCCCAJDOMDCMProyectoIPSDomainModel"), "EnableDiagramRules"), new global::System.CodeDom.CodePropertyReferenceExpression(new global::System.CodeDom.CodeThisReferenceExpression(), "Store"));
		...
		public override string[] GetImportsForProcessingRun()
		{
			...
			imports.Add("UPM_IPS.JDCCCAJDOMDCMProyectoIPS");
