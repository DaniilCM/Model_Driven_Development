...
namespace UPM_IPS.JDCCCAJDOMDCMProyectoIPS
{
	...
	/// </remarks>
	public partial class JDCCCAJDOMDCMProyectoIPSHelpKeywordHelper : JDCCCAJDOMDCMProyectoIPSHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSHelpKeywordHelper.
		/// </summary>
		protected JDCCCAJDOMDCMProyectoIPSHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the JDCCCAJDOMDCMProyectoIPSHelpKeywordHelper.
		/// </summary>
		public static JDCCCAJDOMDCMProyectoIPSHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class JDCCCAJDOMDCMProyectoIPSHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSHelpKeywordHelperBase.
		/// </summary>
		protected JDCCCAJDOMDCMProyectoIPSHelpKeywordHelperBase()
			: base() { }
