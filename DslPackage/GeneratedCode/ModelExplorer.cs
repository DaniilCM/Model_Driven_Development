...
namespace UPM_IPS.JDCCCAJDOMDCMProyectoIPS
{
	...
	/// </summary>
	internal partial class JDCCCAJDOMDCMProyectoIPSExplorer : JDCCCAJDOMDCMProyectoIPSExplorerBase
	{
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSExplorer.
		/// </summary>
		public JDCCCAJDOMDCMProyectoIPSExplorer(global::System.IServiceProvider serviceProvider)
	...
	/// <summary>
	/// Control hosted in the JDCCCAJDOMDCMProyectoIPSExplorerToolWindow.
	/// </summary>
	internal abstract class JDCCCAJDOMDCMProyectoIPSExplorerBase : DslShell::ModelExplorerTreeContainer
	{
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSExplorerBase.
		/// </summary>
		protected JDCCCAJDOMDCMProyectoIPSExplorerBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		...
		protected override global::System.ComponentModel.Design.CommandID ContextMenuCommandId
		{
			get
			{
				return Constants.JDCCCAJDOMDCMProyectoIPSExplorerMenu;
			}
		}
