...
namespace UPM_IPS.JDCCCAJDOMDCMProyectoIPS
{
	...
	/// </summary>
	internal partial class JDCCCAJDOMDCMProyectoIPSCommandSet : JDCCCAJDOMDCMProyectoIPSCommandSetBase
	{
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSCommandSet.
		/// </summary>
		public JDCCCAJDOMDCMProyectoIPSCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class JDCCCAJDOMDCMProyectoIPSCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSCommandSetBase.
		/// </summary>
		protected JDCCCAJDOMDCMProyectoIPSCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewJDCCCAJDOMDCMProyectoIPSExplorerCommand,
				typeof(JDCCCAJDOMDCMProyectoIPSEditorFactory).GUID);
		...
		{
			JDCCCAJDOMDCMProyectoIPSExplorerToolWindow explorer = this.JDCCCAJDOMDCMProyectoIPSExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		protected JDCCCAJDOMDCMProyectoIPSDocData CurrentJDCCCAJDOMDCMProyectoIPSDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as JDCCCAJDOMDCMProyectoIPSDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected JDCCCAJDOMDCMProyectoIPSDocView CurrentJDCCCAJDOMDCMProyectoIPSDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as JDCCCAJDOMDCMProyectoIPSDocView;
			}
		}
		...
		/// </summary>
		protected JDCCCAJDOMDCMProyectoIPSExplorerToolWindow JDCCCAJDOMDCMProyectoIPSExplorerToolWindow
		{
			get
			{
				JDCCCAJDOMDCMProyectoIPSExplorerToolWindow explorerWindow = null;
				...
				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(JDCCCAJDOMDCMProyectoIPSExplorerToolWindow), true) as JDCCCAJDOMDCMProyectoIPSExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				JDCCCAJDOMDCMProyectoIPSExplorerToolWindow explorerWindow = this.JDCCCAJDOMDCMProyectoIPSExplorerToolWindow;
	...
	/// Double-derived class to allow easier code customization.
	/// </summary>
	internal partial class JDCCCAJDOMDCMProyectoIPSClipboardCommandSet : JDCCCAJDOMDCMProyectoIPSClipboardCommandSetBase
	{
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSClipboardCommandSet.
		/// </summary>
		public JDCCCAJDOMDCMProyectoIPSClipboardCommandSet(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
	}
	...
	/// </summary>
	internal abstract partial class JDCCCAJDOMDCMProyectoIPSClipboardCommandSetBase : DslShell::ClipboardCommandSet
	{
		/// <summary>
		/// Constructs a new JDCCCAJDOMDCMProyectoIPSClipboardCommandSetBase.
		/// </summary>
		protected JDCCCAJDOMDCMProyectoIPSClipboardCommandSetBase(global::System.IServiceProvider serviceProvider)
			: base(serviceProvider)
		{
		}
